...
class OpsBFiles(ReadFileTemplate):
    ...
    def classifiles(self):
        ...
        if re.findall("administration\.log|administration\.log\d", self.file, re.IGNORECASE):
...
if __name__ == "__main__":
    # 读取测试文件
    file = r"D:\GitHub\LogAnalysis\test\opsb_log\helm-opsb\helm-opsb__itom-di-administration-cd6c8d6c-qhhqn__administration__vm-opsb.home.local\administration.log"
