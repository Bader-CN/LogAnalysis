...
class ITOM_OpsB_Content_Manager(BASE):
    """
...
class ITOM_Ingress_Controller(BASE):
    """
    OpsB deployments itom-opsb-ingress-controller
    """
    __tablename__ = "opsb_itom_ingress_controller"
...
class ITOM_Core_Frontend_Ingress_Controller(BASE):
    """
    OpsB core deployments frontend-ingress-controller
    """
    __tablename__ = "opsb_core_frontend_ingress_controller"
...
class ITOM_Core_Portal_Ingress_Controller(BASE):
    """
    OpsB core deployments portal-ingress-controller
    """
    __tablename__ = "opsb_core_portal_ingress_controller"
...
class ITOM_Core_Frontend_UI(BASE):
    """
    OpsB core deployments itom-frontend-ui
    """
    __tablename__ = "opsb_core_itom_frontend_ui"
...
class ITOM_Core_Kube_Registry(BASE):
    """
    OpsB core deployments kube-registry
    """
    __tablename__ = "opsb_core_kube_registry"
...
class ITOM_K8S_Containerd(BASE):
    """
    OpsB K8S Containerd Service
    """
    __tablename__ = "k8s_service_containerd"
...
class ITOM_K8S_Kubelet(BASE):
    """
    OpsB K8S Kubelet Service
    """
    __tablename__ = "k8s_service_kubelet"
